# Class that simulates the functionality of opencv so secureEye can use ffmpeg seamlessly
...
class ffmpeg_reader:
    """This class was created to look as similar to the openCV features used in SecureEye as possible for overall code cleanliness."""
    ...
    def record(self, numframes):
        ...
        self.video = numpy.frombuffer(stream, numpy.uint8).reshape([-1, self.width, self.height, 3])
